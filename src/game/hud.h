...
#define HUD_POWER_METER_X            275
#define HUD_POWER_METER_EMPHASIZED_Y 166
#define HUD_POWER_METER_Y            205
#define HUD_POWER_METER_HIDDEN_Y     300

#define HUD_TOP_Y 209
#define HUD_BOTTOM_Y 15 // Same height as the Lakitu icon

#define HUD_COINS_X 238
#define HUD_STARS_X 298 // This starts counting from the right edge
